...
ATOM_SYMBOL_VOCAB = Vocab(['O','Cu','Mn','As','*','S','Ge','Pt','Cl','Cr','Ti','Ga','Zn','In','F','Br','Ta','Sn','Na','Si','Li','P','B','Al','Mg','K','Bi','C','Ag','Ru','Cd','N','Se','Pb','Hg','Zr','Sb','Xe','I'])

ATOM_ISAROMATIC_VOCAB = Vocab([True, False])
ATOM_FORMALCHARGE_VOCAB = Vocab(["*", -1, 0, 1, 2, 3, 4])
