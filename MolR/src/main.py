...
def main():
    ...
    parser.add_argument('--hn', type=str, default='', help='sample hard negatives')
    parser.add_argument('--neg_size', type=int, default=10, help='number of negatives to sample')
    ...
    parser.add_argument('--gnn_shared', type=bool, default=True, help='shared GNN between molecules and motifs')
